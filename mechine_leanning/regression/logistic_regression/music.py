...
#              
# (sample_rate, X) = wavfile.read("/Users/he/work/bigdata/media/机器学习与数据挖掘/02-回归算法/资料/genres/metal/converted/metal.00065.au.wav")
...
# def plotSpec(g,n):
#     sample_rate, X = wavfile.read("/Users/he/work/bigdata/media/机器学习与数据挖掘/02-回归算法/资料/genres/"+g+"/converted/"+g+"."+n+".au.wav")
#     specgram(X, Fs=sample_rate, xextent=(0,30))
#     plt.title(g+"_"+n[-1])
#              
...
sample_rate, X = wavfile.read(
    "/Users/he/work/bigdata/media/机器学习与数据挖掘/02-回归算法/资料/genres/jazz/converted/jazz.00002.au.wav")
